...
namespace Chapter.Decorator {
    public class BikeWeapon : MonoBehaviour {
        ...
        void OnGUI() {
            ...
            GUI.Label (new Rect (5, 200, 150, 100), "Range: "+ _weapon.Range);
            GUI.Label (new Rect (5, 220, 150, 100), "Strength: "+ _weapon.Strength);
            GUI.Label (new Rect (5, 240, 150, 100), "Cooldown: "+ _weapon.Cooldown);
            GUI.Label (new Rect (5, 260, 150, 100), "Firing Rate: " + _weapon.Rate);
            GUI.Label (new Rect (5, 280, 150, 100), "Weapon Firing: " + _isFiring);

            if (mainAttachment && _isDecorated)
                GUI.Label (new Rect (5, 300, 150, 100), "Main Attachment: " + mainAttachment.name);
            if (secondaryAttachment && _isDecorated)
                GUI.Label (new Rect (5, 320, 200, 100), "Secondary Attachment: " + secondaryAttachment.name);
        }
